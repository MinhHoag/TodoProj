...
export class TaskApiService {
  private url = "https://685a19f09f6ef961115509c9.mockapi.io/";
  ...
  getNameByUser(userId: string): Observable<Task[]> {
    this.blockIfGuest();
    return this.http.get<Task[]>(`${this.url}?userName=${userId}`);
  }
  ...
  deleteTask(id: string | undefined, task: Task): Observable<void> {
    this.blockIfGuest();
